...
def main(args):
    config_name = {'config_chemistry':['330']}
#    config_name = {
#                   
...
#                   'config_big_manufactory':['827', '849', '908']}
    ...
    #                'config_big_manufactory':['827','849','908']
    #                }
    json_file = ['data_accounting_read_statement.json']    # python your_script.py --config config_chemistry --seed 42
...
#                /root/nips_code/response/gpt-4o-mini/config_chemistry/config_chemistry_240/data_accounting_read_statement.json/task1.json
                common_keys = ordered_common_keys(example_path, data_path)
                common_keys = ['task8', 'task10', 'task11', 'task12', 'task16', 'task24', 'task25', 'task26', 'task27', 'task29', 'task31', 'task32', 'task34', 'task35']

                print((common_keys))
                # 迭代共同的 key
                for key in common_keys:

                    folder_path = os.path.join(project_root, 'response', "gpt-4o-mini",key_iterate, f'{key_iterate}_{value}', json_iterate)
                    ...
                    task_descriptions = {key: real['task_description']}
